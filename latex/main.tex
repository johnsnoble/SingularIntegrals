...
\begin{align}
    \int_{-1}^1f(t)log(z_2)dt&=\int_{-1}^{t_2}f(t)(log(c_1)+log(z_3))dt+\int_{t_2}^{t_1}f(t)(log(c_1)+log(z_3))dt\\
    &+\int_{t_1}^1f(t)(log(c_1)+log(z_3))dt\\
    &=log(c_1)\int_{-1}^1f(t)dt+\int_{-1}^{t_2}f(t)log(z_3)dt+\int_{t_2}^{t_1}f(t)(log(z_3)+2\pi)dt\\
    &+\int_{t_1}^1f(t)log(z_3)dt\\
