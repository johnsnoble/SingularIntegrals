...
$$log(z-\lambda s)=log(\frac{z}{\lambda}-s)+log(\lambda)+C_\lambda^z(s)$$
...
Since our recurrence relation has the "diagonal" elements we cannot have this for $S$.
This prompts us to augment $S$ slightly so that we can let it obtain the displacement structure.
