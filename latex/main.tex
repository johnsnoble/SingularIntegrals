...
\begin{align}
    \int_{\partial\Omega_j}\partial_nw_y&=\int_{\partial\Omega_j}\frac{\hat n\cdot x-\hat n\cdot y}{2\pi|x-y|^2}\\
    &=\int_{\partial\Omega_j}\frac{\hat n_jx_j}{2\pi|x-y|^2}dx_j+(\Sigma_{k\neq j}(\hat n_kx_k)-\hat n\cdot y)\int_{\partial\Omega_j}\frac{1}{2\pi|x-y|^2}
\end{align}
